...
public class ConnectionSetup {
     ...
     * with {@link com.device.rxble.exceptions.BleGattException} if the device is not in range.
     */
    ...
    public static class Builder {
         ...
         *                    with {@link com.device.rxble.exceptions.BleGattException} if the device is not in range after a
         *                    30 seconds timeout.
