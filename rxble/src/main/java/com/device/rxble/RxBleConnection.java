...
import com.device.rxble.exceptions.BleCharacteristicNotFoundException;
...
import com.device.rxble.internal.operations.CharacteristicLongWriteOperation;
...
public interface RxBleConnection {
     ...
     * the notification will not be set up and will emit an BleCharacteristicNotificationOfOtherTypeAlreadySetException
     * <p>
     * The characteristic can be retrieved from {@link com.device.rxble.RxBleDeviceServices} emitted from
