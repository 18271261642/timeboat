 ...
 * {@link com.device.rxble.RxBleConnection#readCharacteristic(UUID)} or
 * {@link com.device.rxble.RxBleConnection#setupIndication(UUID)}. If the data in emitted byte arrays is stored using
