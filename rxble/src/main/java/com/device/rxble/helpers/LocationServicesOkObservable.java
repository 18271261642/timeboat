...
/**
 * An Observable that emits false if an attempt to scan with {@link com.device.rxble.RxBleClient#scanBleDevices(UUID...)}
 * would cause the exception {@link com.device.rxble.exceptions.BleScanException#LOCATION_SERVICES_DISABLED}; otherwise emits true.
