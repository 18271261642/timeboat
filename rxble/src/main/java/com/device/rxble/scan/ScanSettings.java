...
import com.device.rxble.internal.scan.ExternalScanSettingsExtension;
...
public class ScanSettings implements Parcelable, ExternalScanSettingsExtension<ScanSettings> {
    ...
    public static final class Builder implements ExternalScanSettingsExtension.Builder {
        ...
        /**
         * {@inheritDoc}
         * If set to true and Location Services are off a {@link com.device.rxble.exceptions.BleScanException} will be emitted.
         * <p>Default: true.</p>
         */
        @Override
