...
public interface BackgroundScanner {
     ...
     * @throws com.device.rxble.exceptions.BleScanException thrown if not possible to start the scan
     */
    @RequiresApi(26 /* Build.VERSION_CODES.O */)
     ...
     * @throws com.device.rxble.exceptions.BleScanException scan failure
     */
