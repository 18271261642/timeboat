...
/**
 * An exception being emitted from {@link com.device.rxble.RxBleConnection#setupNotification(UUID)}/
 * {@link com.device.rxble.RxBleConnection#setupIndication(UUID)} or overloads in case when an opposite
