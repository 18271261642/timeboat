...
public class BleCannotSetCharacteristicNotificationException extends BleException {
     ...
     * {@link com.device.rxble.RxBleConnection#setupNotification(BluetoothGattCharacteristic, NotificationSetupMode)} or
     * {@link com.device.rxble.RxBleConnection#setupIndication(UUID, NotificationSetupMode)} can be used with
