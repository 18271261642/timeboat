...
import com.device.rxble.RxBleConnection.RxBleConnectionState;
...
public class RxBleGattCallback {
     ...
     * It's intended to be used only with a {@link com.device.rxble.RxBleCustomOperation} in a performance
