...
/**
 * An interface that describes what library extensions should be added to {@link com.device.rxble.scan.ScanSettings}
 */
public interface ExternalScanSettingsExtension<R extends ExternalScanSettingsExtension<R>> {
    ...
    interface Builder<T extends Builder<T>> {
         ...
         * Some Android devices will not return any {@link com.device.rxble.scan.ScanResult} if Location Services are
         * disabled.
         *
