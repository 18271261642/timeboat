...
import static com.device.rxble.RxBleConnection.RxBleConnectionState.CONNECTED;
import static com.device.rxble.RxBleConnection.RxBleConnectionState.CONNECTING;
import static com.device.rxble.internal.DeviceModule.CONNECT_TIMEOUT;
import static com.device.rxble.internal.connection.ConnectionComponent.NamedBooleans.AUTO_CONNECT;
import static com.device.rxble.internal.util.DisposableUtil.disposableSingleObserverFromEmitter;
...
public class ConnectOperation extends QueueOperation<BluetoothGatt> {
     ...
     *
     * @return BluetoothGatt after connection reaches {@link com.device.rxble.RxBleConnection.RxBleConnectionState#CONNECTED}
     * state.
     * @throws com.device.rxble.exceptions.BleDisconnectedException if connection was disconnected/failed before
     *                                                                       it was established.
     */
    @NonNull
