...
public interface RxBleDevice {
     ...
     *
     * @return observable that will emit {@link com.device.rxble.RxBleConnection.RxBleConnectionState} changes
     */
     ...
     *                    If false, the connection will fail with {@link com.device.rxble.exceptions.BleGattException} if
