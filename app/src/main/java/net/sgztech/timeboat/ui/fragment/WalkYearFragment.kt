...
class WalkYearFragment:BaseFragment() {
    ...
    private fun updateUIByType(){
        ...
        when(sportDataType){
            ...
            {
                yearBinding.averageSportDescribe.text="平均步数(步)"
                yearBinding.totalSportDescribe.text="总步数(步)"
            }
            WalkDataActivity.distanceType ->{
                yearBinding.averageSportDescribe.text="平均距离(千米)"
                yearBinding.totalSportDescribe.text="总距离(千米)"
            }
            WalkDataActivity.calorieType ->  {
                yearBinding.averageSportDescribe.text="平均热量(千卡)"
                yearBinding.totalSportDescribe.text="总热量(千卡)"
            }
        }
    }
