...
class AddDeviceRepository:BaseRepository() {
    suspend fun addDevice(imei:String,mac :String ,name:String?): HttpResponseModel<BleDeviceInfoModel> {
        ...
        val requestCall = OkHttpUtils
            .postString()
            .url(HttpRequestConfig.addDevices)
            .content(request)
