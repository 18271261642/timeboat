...
class HomePageRepository :BaseRepository() {
    private val TAG = HomePageRepository::class.java.simpleName
    suspend fun getAdList(): HttpResponseModel<List<AdInfoModel>> {
        val url = HttpRequestConfig.homeAdListUrl
        ...
        val responseModel= await(requestCall ,object : BaseRepository.Parser<List<AdInfoModel>> {
