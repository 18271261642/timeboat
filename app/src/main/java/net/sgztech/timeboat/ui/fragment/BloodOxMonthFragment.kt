...
import net.sgztech.timeboat.databinding.FragmentBloodOxMonthBinding
...
class BloodOxMonthFragment : BaseFragment() {
    private val monthBinding: FragmentBloodOxMonthBinding by viewBinding()
    private val bloodOxViewModel : BloodOxViewModel by viewModels()
    private  lateinit var xAxis : XAxis
    private  lateinit var yAxis : YAxis
    private  lateinit var  chatBar : CornerBarChart
    private var monthList = ArrayList<BloodOxygenModel>()
    private var currentTimeStamp = 0L
    private var selectTimeStamp = System.currentTimeMillis()
    companion object {
        fun newInstance(label: String): BloodOxMonthFragment {
            val fragment = BloodOxMonthFragment()
    ...
    override fun getLayoutResId(): Int {
        return R.layout.fragment_blood_ox_month
    }
        ...
        bloodOxViewModel.bloodOxData.vmObserver(this){
            ...
            onAppSuccess = {
                if(it!=null&&it.list!=null){
                    ...
                    monthBinding.averageBloodOxCount.text = "" + it.info.averageBloodOxygen
//                    setData()
...
//        xAxis.setLabelCount(7, true)
    ...
    private fun getSportEntry(sourceData :List<BloodOxygenModel>): List<BarEntry>{
        ...
        if(sourceData.isNotEmpty()){
            monthList = sourceData as ArrayList<BloodOxygenModel>
        }
