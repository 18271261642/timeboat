...
public class CornerBarChartRenderer extends BarLineScatterCandleBubbleRenderer {

    protected BarDataProvider mChart;
    private  int bordCorner = 25 ;
    /**
    ...
    public CornerBarChartRenderer(BarDataProvider chart, ChartAnimator animator,
    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        ...
        if (mChart.isDrawBarShadowEnabled()) {
            ...
            for (int i = 0, count = Math.min((int) (Math.ceil((float) (dataSet.getEntryCount()) * phaseX)), dataSet.getEntryCount());
                ...
                c.drawRoundRect(mBarShadowRectBuffer,(float)bordCorner,(float)bordCorner,mShadowPaint);
...
//                    buffer.buffer[j + 3], mRenderPaint);
            ...
            c.drawRoundRect(rectF,(float)bordCorner,(float)bordCorner,mRenderPaint);


            if (drawBorder) {
                c.drawRoundRect(rectF,(float)bordCorner,(float)bordCorner,mBarBorderPaint);
//                c.drawRect(buffer.buffer[j], buffer.buffer[j + 1], buffer.buffer[j + 2],
